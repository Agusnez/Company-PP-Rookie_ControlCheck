...
<form:form action="register/saveProvider.do" modelAttribute="provider">
	...
	<jstl:if test="${showError == true}">
		<div class="error">
			<spring:message code="provider.commit.error" />
		</div>
	</jstl:if>
...
<jstl:if test="${message!=null }">
	<div class="error"><spring:message code="provider.commit.error" /></div>
</jstl:if> 
